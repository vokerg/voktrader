...
The next unclaimed task after T060 is claimed is:

1. `T042` - unified fee model. Parallel infrastructure work.

Central risk work `T012` is already claimed by open PR #9. CI task `T050` merged through PR #13. Control-plane security task `T044` merged through PR #14. Flyway schema authority task `T051` merged through PR #15. Dependency and SDK contract task `T052` merged through PR #16. Historical tick provenance task `T053` merged through PR #17. Exact depth replay task `T060` is claimed by draft PR #18.
...
| Task | Status | Priority | Depends On | Parallelizable | Title |
| --- | --- | --- | --- | --- | --- |
| [T060](./PHASE-5-simulation-honesty.md#t060) | IN_PROGRESS | P0 | T050 | no | Replay exact recorded depth levels |
