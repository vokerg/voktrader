...
8. `T021` - outbox worker and claim lease. **IN_PROGRESS** in draft PR #32.
9. `T042` - unified fee model. Claimed by draft PR #12 and promoted to P0, but remains paused pending current-head reconciliation; do not absorb it into another task.
10. `T022` through `T025` follow T021 in the durable lifecycle chain, then mandatory phase-exit gate `T026`.
11. `T030` and all exchange-truth work remain blocked until T026.
12. After T055 is DONE, `T054` retained-database rehearsal and `T056` control-plane default-auth proof may proceed in parallel.
13. `T045` live preflight additionally requires T054 and T056.
...
| [T014](./PHASE-1-stop-the-bleeding.md#t014) | DONE | P0 | T016, T013 | no | Prove kill switch covers every live entry route |
...
| [T021](./PHASE-2-durable-order-lifecycle.md#t021) | IN_PROGRESS | P0 | T020 | no | Implement outbox worker and claim lease |
