...
final class StrategyV2FeatureNamespace {
    private static final Set<String> FEATURES = Set.of(
            ...
            "candidate.taker_sell.slippage", "candidate.taker_sell.shares", "candidate.taker_sell.proceeds_usd",
            "candidate.taker_sell.fee_usd", "candidate.taker_sell.net_proceeds_usd",
            ...
            "opposite.taker_sell.fillable", "opposite.taker_sell.avg_price", "opposite.taker_sell.worst_price",
            "opposite.taker_sell.slippage", "opposite.taker_sell.shares", "opposite.taker_sell.proceeds_usd",
            "opposite.taker_sell.fee_usd", "opposite.taker_sell.net_proceeds_usd",
            "opposite.maker_buy.price", "opposite.maker_buy.fee_usd",
            "trade.hold_seconds", "trade.estimated_gross_pnl_usd", "trade.estimated_net_pnl_usd", "trade.estimated_net_pnl_pct",
            ...
            "position.fee_known", "position.unrealized_gross_pnl_usd", "position.unrealized_pnl_usd", "position.unrealized_pnl_pct",
